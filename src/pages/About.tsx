...
export function About() {
  return (
    <div className="flex-grow py-16 px-4 sm:px-8">
      <SEO 
        title="About Us | Rural Ops Tools" 
        description="Learn about the Rural Ops Tools platform, our connected ecosystem of calculators, and our mission to simplify agricultural financial planning." 
        keywords="rural ops tools, agricultural estimation, farm budgeting, rural infrastructure"
      />
      <div className="max-w-3xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-base font-medium text-stone-700 leading-relaxed max-w-2xl">
            Rural Ops Tools is a comprehensive ecosystem of tools and calculators designed to simplify financial planning, procurement, and cost analysis for agriculture, utility infrastructure, and rural development.
          </p>
        </div>
        ...
        <div className="space-y-12 text-stone-900 max-w-2xl">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6 font-medium">
              The Rural Ops Tools platform consists of multiple specialized subdomains, each focusing on a specific area of agricultural and rural cost modeling (such as Forecast, WhatIf, Habitat, Solve, Grid, and many more). This connected network of tools is designed to provide holistic insights by breaking complex systems down into manageable, independent calculators.
            </p>
          </div>
